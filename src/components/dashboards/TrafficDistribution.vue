    ...
    <v-card elevation="10" class="withbg">
        <v-card-item>
            <div class="d-sm-flex align-center justify-space-between pt-sm-2">
                <v-card-title class="text-h5">Gastos mensuales</v-card-title>
            </div>
            <v-row>
                <v-col cols="6" sm="7">
                    <div class="mt-6">
                        <h3 class="text-h4">$3,635,800</h3>
                        <div class="mt-2">
                            ...
                            <span class="text-subtitle-2 text-muted ml-2">último año</span>
                        </div>
                        <div class="d-flex align-center mt-4 ml-1">
                            <h6 class="text-subtitle-2 text-muted">
                                <v-icon icon="mdi mdi-checkbox-blank-circle" class="mr-1" size="10"
                                    color="primary"></v-icon> Alimentación
                            </h6>
